...
//                {
//                    intent.putExtra("selection","happy");
//                }
//                else if(id==R.id.imageView4)
//                {
//                    intent.putExtra("selection","pain");
//                }
//                else if(id==R.id.imageView5)
//                {
//                    intent.putExtra("selection","sad");
//                }
//                else if(id==R.id.imageView6)
//                {
//                    intent.putExtra("selection","frustration");
//                }
//                else if(id==R.id.imageView7)
//                {
//                    intent.putExtra("selection","bored");
//                }
//                else if(id==R.id.imageView8)
//                {
//                    intent.putExtra("selection","hot");
//                }
